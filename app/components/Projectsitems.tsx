...
const Projectsitems: React.FC<ProjectsitemsProps> = ({title, backgroungImg, alt, description, projectUrl}) => {
  return (
    <article className="relative flex items-center justify-center h-auto w-full shadow-gray-400 rounded-xl md:p-4 group hover:bg-gradient-to-r from-tertiary-color to-primary-color">
      <Image
