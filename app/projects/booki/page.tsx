    ...
    <div className="w-full">
      ...
      <div className="max-w-[1440px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p>
            Booki is a simple HTML / CSS project. It is a landing page for a
            booking website. I used HTML and CSS to build it. It is a simple
            project but it helped me to improve my skills in HTML and CSS.
          </p>
